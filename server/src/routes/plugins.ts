...
import type { ToolRunContext } from "@pioneeros/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@pioneeros/plugin-sdk";
import {
  assertAuthenticated,
  assertBoard,
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@pioneeros/plugin-hello-world-example",
  ...
  {
    packageName: "@pioneeros/plugin-file-browser-example",
  ...
  {
    packageName: "@pioneeros/plugin-kitchen-sink-example",
  ...
  {
    packageName: "@pioneeros/plugin-orchestration-smoke-example",
