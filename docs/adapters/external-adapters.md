...
```json
{
  ...
  "dependencies": {
    "@pioneeros/adapter-utils": "^2026.325.0",
    "picocolors": "^1.1.0"
  },
  "devDependencies": {
    "@types/node": "^22.0.0",
...
```ts
import type { ServerAdapterModule } from "@pioneeros/adapter-utils";
...
#### Available Helpers from `@pioneeros/adapter-utils`
...
```ts
import type { AdapterSessionCodec } from "@pioneeros/adapter-utils";
