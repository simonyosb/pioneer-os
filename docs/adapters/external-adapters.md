...
```json
{
  ...
  "dependencies": {
    "@ardonex/adapter-utils": "^2026.325.0",
    "picocolors": "^1.1.0"
  },
  "devDependencies": {
    "@types/node": "^22.0.0",
...
```ts
import type { ServerAdapterModule } from "@ardonex/adapter-utils";
...
#### Available Helpers from `@ardonex/adapter-utils`
...
```ts
import type { AdapterSessionCodec } from "@ardonex/adapter-utils";
