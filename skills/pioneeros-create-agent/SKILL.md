...
`skills/pioneeros-create-agent/references/agent-instruction-templates.md`

Generic fallback for no-template hires:
`skills/pioneeros-create-agent/references/baseline-role-guide.md`
...
`skills/pioneeros-create-agent/references/draft-review-checklist.md`
...
- Template index and how to apply a template: `skills/pioneeros-create-agent/references/agent-instruction-templates.md`
- Individual role templates: `skills/pioneeros-create-agent/references/agents/`
- Generic baseline role guide (no-template fallback): `skills/pioneeros-create-agent/references/baseline-role-guide.md`
- Pre-submit draft-review checklist: `skills/pioneeros-create-agent/references/draft-review-checklist.md`
- Endpoint payload shapes and full examples: `skills/pioneeros-create-agent/references/api-reference.md`
