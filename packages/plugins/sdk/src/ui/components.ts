 ...
 *
 * These components are exported from `@ardonex/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@ardonex/plugin-sdk/ui`
 */
 ...
 * @example
 * ```tsx
 * import { FileTree, type FileTreeNode } from "@ardonex/plugin-sdk/ui";
 *
