 ...
 *
 * These components are exported from `@pioneeros/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@pioneeros/plugin-sdk/ui`
 */
 ...
 * @example
 * ```tsx
 * import { FileTree, type FileTreeNode } from "@pioneeros/plugin-sdk/ui";
 *
