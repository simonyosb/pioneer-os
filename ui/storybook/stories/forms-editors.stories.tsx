...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "@pioneeros/shared";
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @pioneeros/ui typecheck", "pnpm build-storybook"],
