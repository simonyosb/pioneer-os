...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "@ardonex/shared";
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @ardonex/ui typecheck", "pnpm build-storybook"],
